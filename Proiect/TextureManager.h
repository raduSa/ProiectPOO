...
class TextureManager {
	...
	SDL_Texture* block;
	SDL_Texture* blockInverted;
	SDL_Texture* crouchBlock;
	SDL_Texture* crouchBlockInverted;
	SDL_Texture* hit;
	SDL_Texture* hitInverted;
	SDL_Texture* crouchHit;
	SDL_Texture* crouchHitInverted;
